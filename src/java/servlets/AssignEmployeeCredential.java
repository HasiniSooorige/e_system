...
@WebServlet(name = "AssignEmployeeCredential", urlPatterns = {"/AssignEmployeeCredential"})

public class AssignEmployeeCredential extends HttpServlet {
...
//            Employee employee;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, NullPointerException {
        ...
        System.out.println("ACTIVATE CEREDENTIAL");
        ...
        try {
            ...
            if (mn == null) {
                ...
                System.out.println("---- ");
                if (mn.getIsResigned() == false) {
                    mn.setIsResigned(true);
                } else {
                    mn.setIsResigned(false);
                }
