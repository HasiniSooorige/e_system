...
@WebServlet(name = "CreateAccessEmployeeCredential", urlPatterns = {"/CreateAccessEmployeeCredential"})

public class CreateAccessEmployeeCredential extends HttpServlet {
